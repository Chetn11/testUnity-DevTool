...
function ResponseDetails({section,selectedItem,setRightSide,handleSelectSection}) {
  return (
              ...
              <div className={styles.responseCard}>
                {section === "Headers" && (
                  <div className={styles.headers}>
                    ...
                    <div>
                      <span>Status</span>
                      <span>{selectedItem.status}  {selectedItem.statusText}</span>
                    </div>
                    <div>
                      <span>Duration</span>
                ...
                {section === "Preview" && <pre>{selectedItem.data}</pre>}
                ...
                {section === "Timing" && (
                  <div style={{ fontSize: "larger", padding: "10px" }}>
                    Request has taken {Math.round(selectedItem.duration || 0)} ms to complete
                  </div>
                )}
              </div>
            </div>
